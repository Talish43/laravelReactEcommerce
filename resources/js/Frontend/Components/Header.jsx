            ...
            <div className="banner_bg_main">
                ...
                <div className="logo_section">
                    <div className="container">
                        <div className="row">
                            <div className="col-sm-12">
                                <div className="logo"><a href="index.html"><img src="/assets/frontend/images/logo.png" /></a></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="header_section">
                    <div className="container">
                        <div className="containt_main">
                            ...
                            <span className="toggle_icon" onClick={openNav}><img src="/assets/frontend/images/toggle-icon.png" /></span>
                            ...
                            <div className="header_box">
                                <div className="lang_box ">
                                    <a href="#" title="Language" className="nav-link" data-toggle="dropdown" aria-expanded="true">
                                        <img src="/assets/frontend/images/flag-uk.png" alt="flag" className="mr-2 " title="United Kingdom" /> English <i className="fa fa-angle-down ml-2" aria-hidden="true" />
                                    </a>
                                    <div className="dropdown-menu ">
                                        <a href="#" className="dropdown-item">
                                            <img src="/assets/frontend/images/flag-france.png" className="mr-2" alt="flag" />
                                            French
                                        </a>
                                    </div>
                                </div>
