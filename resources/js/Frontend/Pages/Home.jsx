                                  ...
                                  <div className="row">
                                      <div className="col-lg-4 col-sm-4">
                                          <div className="box_main">
                                              ...
                                              <div className="tshirt_img"><img src="/assets/frontend/images/tshirt-img.png" /></div>
                                      ...
                                      <div className="col-lg-4 col-sm-4">
                                          <div className="box_main">
                                              ...
                                              <p className="price_text">Price  <span style={{color: '#262626'}}>$ 30</span></p>
                                              <div className="tshirt_img"><img src="/assets/frontend/images/dress-shirt-img.png" /></div>
                                              <div className="btn_main">
                                                  <div className="buy_bt"><a href="#">Buy Now</a></div>
                                                  <div className="seemore_bt"><a href="#">See More</a></div>
                                              </div>
                                      ...
                                      <div className="col-lg-4 col-sm-4">
                                          <div className="box_main">
                                              ...
                                              <p className="price_text">Price  <span style={{color: '#262626'}}>$ 30</span></p>
                                              <div className="tshirt_img"><img src="/assets/frontend/images/women-clothes-img.png" /></div>
                                              <div className="btn_main">
                                                  <div className="buy_bt"><a href="#">Buy Now</a></div>
                                                  <div className="seemore_bt"><a href="#">See More</a></div>
                                              </div>
                                  ...
                                  <div className="row">
                                      <div className="col-lg-4 col-sm-4">
                                          <div className="box_main">
                                              ...
                                              <div className="electronic_img"><img src="/assets/frontend/images/laptop-img.png" /></div>
                                              <div className="btn_main">
                                                  <div className="buy_bt"><a href="#">Buy Now</a></div>
                                                  <div className="seemore_bt"><a href="#">See More</a></div>
                                              </div>
                                      ...
                                      <div className="col-lg-4 col-sm-4">
                                          <div className="box_main">
                                              ...
                                              <p className="price_text">Start Price  <span style={{color: '#262626'}}>$ 100</span></p>
                                              <div className="electronic_img"><img src="/assets/frontend/images/mobile-img.png" /></div>
                                              <div className="btn_main">
                                                  <div className="buy_bt"><a href="#">Buy Now</a></div>
                                                  <div className="seemore_bt"><a href="#">See More</a></div>
                                              </div>
                                      ...
                                      <div className="col-lg-4 col-sm-4">
                                          <div className="box_main">
                                              ...
                                              <p className="price_text">Start Price  <span style={{color: '#262626'}}>$ 100</span></p>
                                              <div className="electronic_img"><img src="/assets/frontend/images/computer-img.png" /></div>
                                              <div className="btn_main">
                                                  <div className="buy_bt"><a href="#">Buy Now</a></div>
                                                  <div className="seemore_bt"><a href="#">See More</a></div>
                                              </div>
                                  ...
                                  <div className="row">
                                      <div className="col-lg-4 col-sm-4">
                                          <div className="box_main">
                                              ...
                                              <p className="price_text">Start Price  <span style={{color: '#262626'}}>$ 100</span></p>
                                              <div className="jewellery_img"><img src="/assets/frontend/images/jhumka-img.png" /></div>
                                              <div className="btn_main">
                                                  <div className="buy_bt"><a href="#">Buy Now</a></div>
                                                  <div className="seemore_bt"><a href="#">See More</a></div>
                                              </div>
                                      ...
                                      <div className="col-lg-4 col-sm-4">
                                          <div className="box_main">
                                              ...
                                              <p className="price_text">Start Price  <span style={{color: '#262626'}}>$ 100</span></p>
                                              <div className="jewellery_img"><img src="/assets/frontend/images/neklesh-img.png" /></div>
                                              <div className="btn_main">
                                                  <div className="buy_bt"><a href="#">Buy Now</a></div>
                                                  <div className="seemore_bt"><a href="#">See More</a></div>
                                              </div>
                                      ...
                                      <div className="col-lg-4 col-sm-4">
                                          <div className="box_main">
                                              ...
                                              <p className="price_text">Start Price  <span style={{color: '#262626'}}>$ 100</span></p>
                                              <div className="jewellery_img"><img src="/assets/frontend/images/kangan-img.png" /></div>
                                              <div className="btn_main">
                                                  <div className="buy_bt"><a href="#">Buy Now</a></div>
                                                  <div className="seemore_bt"><a href="#">See More</a></div>
                                              </div>
